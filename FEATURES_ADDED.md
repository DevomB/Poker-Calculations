...
Complete inventory of what the **npm package** ships: **96** native JavaScript functions, **7** TypeScript result/state types, card conventions, and C++ engine primitives that are not re-exported to Node.
...
## JavaScript / N-API exports (96 functions)
