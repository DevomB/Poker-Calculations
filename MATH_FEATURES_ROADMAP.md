...
This file is the **single index** for shipped math, how to extend the library, and a **quality-gated** backlog of esoteric ideas. Detailed export tables: [`FEATURES_ADDED.md`](FEATURES_ADDED.md). Examples and API walkthroughs: [poker-calculations.devomb.com](https://poker-calculations.devomb.com).
