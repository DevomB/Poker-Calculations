...
These files are **not committed** to git (large binaries). They are produced in CI ([`.github/workflows/native-prebuild.yml`](../.github/workflows/native-prebuild.yml)) or locally before `npm publish`.
